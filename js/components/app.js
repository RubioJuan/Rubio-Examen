class ExamenFiltro extends HTMLElement {
    constructor() {
        super();
        this.render();
    }
    render(){
        this.innerHTML = /* html*/ `
            ...
            <h2 class="titulo22">¿Qué nivel de calidad esta buscando?</h2>
                <div class="containertasks">
                    <div class="containerInfo">
                        <div class="dates">
                            <img src="images/img1.png">
                            <ul class="side-dropdown">
                                <li id="btnIr1"><a href="#"><h3 class="titulo2">Calidad óptima</h3></a></li>
                            </ul>
                        </div>
                        <div class="dates1">
                            <img src="images/answer-1-2.png">
                            <h3 class="titulo2">Buena relación calidad/precio</h3>
                        </div>
                        <div class="dates2">
                            <img src="images/answer-1-3.png">
                            <h3 class="titulo2">No me importa tanto la calidad</h3>
                        </div>
                    </div>
                    <br>
                </div>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                document.getElementById("btnIr").addEventListener("click", function(event) {
